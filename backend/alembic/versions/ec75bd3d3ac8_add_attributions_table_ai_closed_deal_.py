"""add attributions table (AI-closed-deal tracking)

Revision ID: ec75bd3d3ac8
Revises: b73ff5e6de9b
Create Date: 2026-09-20 23:19:28.926577
...
revision = 'ec75bd3d3ac8'
down_revision = 'b73ff5e6de9b'
branch_labels = None
depends_on = None
